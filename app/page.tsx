    ...
    <main>
      ...
      <Block id='our_numbers'>
        ...
        <ul className='grid gap-6 grid-cols-1 lg:grid-cols-2'>
          <li className='text-xl border border-zinc-600 w-96 p-2 rounded-md'><p>+10 anos de atuação</p></li>
          <li className='text-xl border border-zinc-600 w-96 p-2 rounded-md'><p>+300 clientes satisfeitos</p></li>
          <li className='text-xl border border-zinc-600 w-96 p-2 rounded-md'><p>+500 filmes registrados</p></li>
          <li className='text-xl border border-zinc-600 w-96 p-2 rounded-md'><p>+2.000 projetos e filmes entregues</p></li>
        </ul>
      </Block>
    </main>
  );
